...
public class TransactionsLinkedList implements TransactionsList {
    ...
    public void delTransactionById(UUID id) {
        ...
        if (id == null) throw new TransactionNotFoundException("Транзация с таким id отсутствует!");
        ...
        throw new TransactionNotFoundException("Транзация с таким id отсутствует!");
    }
    @Override
