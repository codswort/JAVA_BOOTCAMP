...
public class Transaction {
    ...
    public Transaction(Category transferCategory, User sender, User recipient, double transferAmount) {
        if (transferCategory == Category.DEBIT && transferAmount < 0 ||
            ...
            updateBalance(this.transferCategory, this.sender, this.recipient, transferAmount);
        }

    }
    private void updateBalance(Category transferCategory, User sender, User recipient, double transferAmount) {
